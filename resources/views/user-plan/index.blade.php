                            ...
                            <div class="col-xl-6 col-lg-12">
                                <div class="card js_one_div" data-get_instance_url="{{ route('user-plan.getInstances', $userInstance->instance_id) }}">
                                    <div class="card-header d-flex justify-content-between">
                                        <h4 class="card-title">{{ $userInstance->instance->name_ru }}</h4>
                                        <a href=""
                    ...
                    if(response.success) {
                        response.data.forEach((item) => {
                            if ((typeof instance_id !== 'undefined') && (instance_id === item.id)) {
                                options += '<option value="' + item.id + '" selected>' + item.name_ru + '</option>';
                            }
                            else {
                                options += '<option value="' + item.id + '">' + item.name_ru + '</option>';
                            }
                        })
                        select.html(options)
                    }
